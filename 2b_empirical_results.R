...
# load data
est_theta <- read.csv(file.path(out_dir, "clean_data/theta_estimates.csv"))
est_gamma <- read.csv(file.path(out_dir, "clean_data/gamma_estimates.csv"))
...
# Write to file
writeLines(latex_lines, file.path(out_dir, "tables/elasticity_estimates_table.tex"))
...
load(file.path(out_dir, "clean_data/industry_tfp.RData"))
