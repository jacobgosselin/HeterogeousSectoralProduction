...
# load data
load(file.path(out_dir, "raw_data/BEA_supply&use.RData"))
...
load(file.path(out_dir, "raw_data/BEA_price.RData"))
...
save(analysis_data, analysis_data_filtered, file = file.path(out_dir, "clean_data/analysis_data.RData"))
# write csv for python
write.csv(analysis_data, file = file.path(out_dir, "clean_data/analysis_data.csv"), row.names = FALSE)
write.csv(analysis_data_filtered, file = file.path(out_dir, "clean_data/analysis_data_filtered.csv"), row.names = FALSE)
