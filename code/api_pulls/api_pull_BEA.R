...
# get Make and Use data for all years
make_JSON_raw <- getDatIO("262")
make_data_raw <- make_JSON_raw$BEAAPI$Results$Data[[1]]
use_JSON_raw <- getDatIO("259")
use_data_raw <- use_JSON_raw$BEAAPI$Results$Data[[1]]
save(make_JSON_raw, make_data_raw, use_JSON_raw, use_data_raw, file = "data/raw/api_pull_BEA/make&use.RData")
...
value_added_JSON_raw <- getDatGDP("1")
