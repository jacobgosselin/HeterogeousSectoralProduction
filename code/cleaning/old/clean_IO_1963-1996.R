...
wrapper <- function(year) {
  use <- load_raw(paste0("./raw/IOTables_1947-1996/IOUse_Before_Redefinitions_PRO_1963-1996_Summary.xlsx"), year)
  make <- load_raw(paste0("./raw/IOTables_1947-1996/IOMake_Before_Redefinitions_1963-1996_Summary.xlsx"), year)
...
save(A_byyear_1963_1996, file = "./cleaned/A_byyear_1963-1996.RData")
rm(list = ls())