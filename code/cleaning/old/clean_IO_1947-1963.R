...
wrapper <- function(year) {
  use <- load_raw(paste0("./raw/IOTables_1947-1996/IOUse_Before_Redefinitions_PRO_1947-1962_Summary.xlsx"), year)
  make <- load_raw(paste0("./raw/IOTables_1947-1996/IOMake_Before_Redefinitions_1947-1962_Summary.xlsx"), year)
...
save(A_byyear_1947_1962, file = "./cleaned/A_byyear_1947-1962.RData")
rm(list = ls())