...
intermediate_inputs_1997_2022 <- read_excel("raw/IntermediateInputs.xlsx", 
                                  sheet = "TII105-A", skip = 6)
intermediate_inputs_1997_2022$'Industry Description' <- intermediate_inputs_1997_2022$...2
intermediate_inputs_1997_2022 <- intermediate_inputs_1997_2022[, -c(1:3)]
...
load("cleaned/A_byyear_1997-2022.RData")
...
A_Int_byyear_1997_2022 = gen_A_tilde(A_byyear_1997_2022, intermediate_inputs_1997_2022)
...
save(A_Int_byyear_1997_2022, file = "cleaned/A_Int_byyear_1997_2022.RData")
