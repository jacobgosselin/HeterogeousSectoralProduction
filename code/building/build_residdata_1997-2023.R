...
# rename val column to delta_1 (use cost share rather than revenue share)
...
# resid data: merge delta ijt data with price data ------------------
...
# subset 1998-2023, only data with variance in lagged prices (chain measure)
