...
save(supply_JSON_raw, supply_data_raw, use_JSON_raw, use_data_raw, file = file.path(out_dir, "raw_data/BEA_supply&use.RData"))
...
save(output_price_JSON_raw, output_price_data_raw, II_price_JSON_raw, II_price_data_raw, file = file.path(out_dir, "raw_data/BEA_price.RData"))

# get Defense Spending
defense_use_JSON_raw <- getDatNIPA("T31106")
defense_spending <- defense_use_JSON_raw$BEAAPI$Results$Data[[1]]
save(defense_use_JSON_raw, defense_spending, file = file.path(out_dir, "raw_data/BEA_defense_spending.RData"))