...
# load data
load(file.path(out_dir, "clean_data/analysis_data.RData"))
load(file.path(out_dir, "clean_data/code_desc_crosswalk.RData"))
load(file.path(out_dir, "raw_data/BEA_defense_spending.RData"))
...
FRED <- read.csv(file.path(out_dir, "raw_data/FDEFX.csv"))
...
# Load TFP Data
tfp_KLEMS <- read_excel(file.path(out_dir, "raw_data/major-industry-total-factor-productivity-klems.xlsx"),
                      sheet = "Annual", skip = 2)
...
summary_naics_crosswalk <- read_excel(file.path(out_dir, "raw_data/BEA-Industry-and-Commodity-Codes-and-NAICS-Concordance.xlsx"),
                                      skip = 4)
...
ILPA <- read_excel(file.path(out_dir, "raw_data/BEA-BLS-industry-level-production-account-1987-2021.xlsx"),
                   sheet = "TFP", skip = 1)
...
save(atalay_data, file = file.path(out_dir, "clean_data/atalay_data.RData"))
