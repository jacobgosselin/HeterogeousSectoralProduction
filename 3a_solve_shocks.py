...
if RUN_SEVERE_DOMESTIC:
    ...
    severe_shocks_results.to_csv(os.path.join(out_dir, 'clean_data/severe_shocks_results.csv'), index=True)
...
if RUN_SEVERE_FOREIGN:
    ...
    foreign_price_shock_results.to_csv(os.path.join(out_dir, 'clean_data/foreign_price_shock_consumption.csv'), index=True)
    for cn in ['main', 'common_theta']:
        sectoral_price_responses[cn].to_csv(os.path.join(out_dir, f'clean_data/foreign_price_shock_sectoral_prices_{cn}.csv'), index=True)
...
if RUN_CALIBRATED:
    ...
    calibration_shocks_results.to_csv(os.path.join(out_dir, 'clean_data/calibration_shocks_results.csv'), index=True)
    for cn in calibrated_configs:
        sectoral_output_results[cn].to_csv(os.path.join(out_dir, f'clean_data/sectoral_outputs_{cn}.csv'), index=True)
        sectoral_price_results[cn].to_csv(os.path.join(out_dir, f'clean_data/sectoral_prices_{cn}.csv'), index=True)
